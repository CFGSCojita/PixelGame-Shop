<?php
    ...
    // Preparamos la consulta SQL para insertar un nuevo videojuego en la base de datos, incluyendo la categoría y plataforma.
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        echo "No se ha podido añadir el videojuego por algún error: " . mysqli_error($conn);
    }
